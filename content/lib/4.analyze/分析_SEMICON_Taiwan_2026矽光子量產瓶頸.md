...
## 2026-08-31 Fubon SEMICON Taiwan 2026 補充

- [[事件分析_Semicon 2026_083126]]將展會觀察從單一晶圓製造延伸到 Chiplet、2.5D／3D 封裝、測試、矽光子與智慧製造，與本頁「量產驗證」主軸一致。
- Fubon 引 SEMI 估計 2026 年全球測試設備銷售額約 US$15.3bn、年增 31%；此為產業估計，支持高功率、高頻率、高速 I/O 測試需求上升，但不代表個別測試廠已取得訂單。
- 設備觀察涵蓋先進鍵合、面板級封裝、RDL、清洗與量測；[[6510_精測（市）]]、[[6515_穎崴（市）]]、[[2360_致茂（市）]]列為需追蹤的測試／量測受惠鏈。
