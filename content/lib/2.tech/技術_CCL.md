...
## 2026-08-18 南亞 CCL 漲價訊號

- [[報告_華鑫證券_AI算力與CPO及CCL_20260818]]（華鑫證券，2026-08-18）轉述南亞塑膠自 2026-09 起調漲 CCL 及基材價格；漲幅、客戶轉嫁率與對毛利率的影響仍待公司公告及後續財報確認。
- [[報告_上海證券_高階PCB與硬體架構_20260818]]（上海證券，2026-08-18）則把高階樹脂、銅箔、玻纖布與 CCL 視為 AI PCB 的共同瓶頸；材料供需偏緊不代表所有 CCL 廠商均能同比受惠。
## 2026-08-23 產業更新
...
## 2026-09 Morgan Stanley AI 材料研究補充
...
## 2026-09-18 南亞 M10 驗證更新

- 南亞表示 M10 目前僅與另一家台灣同業送樣，初步驗證預計 1Q27；高階 hydrocarbon resin 自研、關鍵原料由集團供應，有助降低材料取得風險，但不代表已完成客戶認證。
- M7 以上高階產品占比仍低於 5%、M4 約 10%；CCL 月產能 2026 年底將由 618 萬張再增 30 萬張，產能擴張與高階有效供給需分開追蹤。

來源：[[報告_CTBC_南亞_20260918]]（中信投顧，2026-09-18）。

## 2026-09-17 CPO 對高階 CCL 的短期影響

Morgan Stanley 認為 CPO 把光引擎與 ASIC 放在同一封裝旁，長期確實可能縮短高速電氣路徑、降低部分超低 Dk／Df CCL 需求；但 scale-up 架構目前仍受成本、製造良率、可靠度、維修性與散熱限制。

- 2026–2028 年前，CPO 尚不足以造成高階 CCL 的廣泛需求中斷。
- 台光電（EMC）與台燿（TUC）的高階 CCL 需求與券商獲利估計暫未受此議題實質下修。
- CPO 影響應拆成「長期材料內容風險」與「短期高階 CCL 供需」兩個時間尺度，不能由 CPO 導入直接推論 CCL 需求消失。

以上為 Morgan Stanley 產業判斷；不代表個別公司已確認訂單或量產承諾。
