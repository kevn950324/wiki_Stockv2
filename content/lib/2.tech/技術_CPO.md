...
## 2026-09-01 Lumentum／UHP／ELS／COS 法說補充

- 使用者法說整理將 UHP laser 視為 ELSFP 與 CPO／NPO 放量的關鍵供給瓶頸，並轉述 Lumentum 的 UHP 營收爬坡目標；此為公司展望的二次整理，尚非已驗證出貨。
- EML 供需缺口延續，1.6T 世代 CW／SiPh 比例可能提升；OCS 亦被視為光學域導入後的機櫃網路延伸。這些訊號支持「光源、封裝與交換架構同步演進」，但不等於特定 NV 平台已採用。
...
## 2026-09-18 光焱 NightJar-H 更新

- 光焱 NightJar-H 預計於 2026 年底前進入 HVM／客戶驗證，產品可延伸至 CPO／PIC 的晶圓級光譜與光功率映射；CPO 商用化窗口仍以 2027–2028 年觀察。
