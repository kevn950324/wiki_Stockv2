...
> [!info] 混合鍵合 vs TCB 過渡期（HBM4 世代）
> 
> | 時期 | 主流接合方式 | 說明 |
> |------|------------|------|
> | 2025-2026 | TCB（熱壓接合）全盛 | TC-NCF（Non-Conductive Film）主流；HBM3e 16-hi TCB |
> | 2027-2028 | TCB + 混合鍵合並行 | HBM4 12-hi 率先引入混合鍵合；Amkor商業甜蜜點 6µm |
> | 2029+ | 混合鍵合主流化 | HBM4E 16-hi 以後混合鍵合必要（bump pitch 物理限制）|
>
...
![[報告_晶圓到先進封裝全流程_20260528_004.png]]
...
| 接合方式 | TC-NCF（熱壓非導電膜） | MR-MUF（大量回焊 + 底填充）|
|---------|---------------------|--------------------------|
| 溫度 | ~250°C（逐層壓合）| ~230-240°C（一次回焊）|
| 優點 | 每層獨立壓合，精度高 | 吞吐量高、成本低 |
| 缺點 | 16-hi 下熱預算累計偏高 | 大面積底填難均勻 |
| 主要採用 | SK Hynix（HBM3e-16hi），三星早期 | 三星（HBM4 嘗試）|
| 混合鍵合關係 | HB 取代 TC-NCF 需求（2029+）| MR-MUF 被 HB 取代壓力較小 |
...
- [[報告_先進封裝技術發展方向_20260722]]（定錨，2026-07-22；TCB→混合鍵合過渡時程、Amkor 6µm 甜蜜點、TC-NCF vs MR-MUF、nanotwinned 銅）
