...
- [[報告_未具名_記憶體液冷與NPO_20260719]]（2026-07-19）
...
### 2026-09-01 使用者法說整理補充

- 使用者轉述 EML 供需缺口與上季相近、持續供不應求至年底；高功率雷射缺口則因 CPO／NPO／ELS 需求訊號上修而擴大。
- UHP laser 營收目標轉述為 2026 年底單季約 US$50M、2027 年初翻倍、2027 年底再翻倍；UHP 驗證與 COS 封測被連結至 ELSFP／CPO／NPO，且提及 Judge（聯鈞）角色。數字與供應鏈關係尚待公司原始資料交叉驗證，信心低至中。
- 1.6T 放量後 CW／SiPh 比例可能提高；800G 目前仍以 200G-per-lane EML 為主，200G 占 EML 出貨已逾 25%，預期明年中過半。InP 基板可能成為瓶頸，AXT 合作被視為供給保障措施。
- OCS 上季出貨翻倍，本季預期超過 US$100M，2026H2 US$400M 以上目標不變；仍應區分公司展望、使用者轉述與實際認列。
