...
- [[報告_MorganStanley_AI隱形基礎建設_20260913]]首次給予 Overweight、目標價 NT$8,400，估 2026／2027／2028E EPS 為 NT$122.17／266.24／416.24；均屬券商 estimate。
- 報告將認證、良率與上游材料取得列為高階 CCL 的核心門檻；PTFE 路線、CPO 加速與中國供應商認證則可能影響未來份額與估值。
...
- Morgan Stanley 認為 CPO 是高階 CCL 的長期風險，但在 2026–2028 年前，成本、良率、可靠度、維修性與散熱等導入障礙仍使 scale-up 架構難以快速取代 PCB 高速電氣路徑。
- 因此目前對台光電的高階 CCL 需求與獲利估計影響有限；CPO 題材造成的 CCL 股價回檔，研究觀點偏向可重新評估的累積機會。以上為券商產業判斷，非公司訂單或指引。
...
- [[JPM_PCB__CCL_and_Substra_2026-09-01_5431668(1)]]將 Rubin Ultra／NVL576 的主要材料問題定義為 Df ≤0.0004 與可製造性；M10／PTFE hybrid 與 glass-less 方案仍在評估，未揭露台光電特定份額。
- 相關材料認證、低損耗樹脂與玻纖布搭配屬技術路線觀察，不能直接視為 NVIDIA 已下單。
