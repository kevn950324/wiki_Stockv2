...
- GFHK 將鴻海列為 Rubin 平台 ODM／OEM 受惠者之一，並與 Supermicro 一起列為 AI 伺服器整合觀察標的；此為產業鏈觀察，未等同鴻海已取得特定 Rubin 訂單。來源：[[報告_GHHK_AI伺服器散熱_20260901]]。
...
- [[260807_ms_nvl72-racks]]（2026-08-07）
...
- [[報告_GoldmanSachs_鴻海2317_20260907]]（2026-09-07）
- [[報告_JPMorgan_Google2Q26伺服器供應鏈_20260723]]（2026-07-23）
- [[報告_MS_伺服器市場_20250616]]（2025-06-16）
- [[報告_MorganStanley_SEMICON台灣_20260902]]（2026-09-02）
- [[報告_凱基投顧_美國軟體產業_ORCL_SNOW_MDB_20260611]]（2026-06-11）
- [[富鼎(8261,Note)-CTBC260730]]（2026-07-30）
...
- Citi 認為鴻海可受惠 Vera Rubin rack 的較高 ASP，即使 rack 數量增速放緩，只要毛利率大致穩定，營收與獲利仍可能上升；鴻海亦在布局客製 ASIC／hyperscaler 的 CPU、TPU 相關系統，較有意義的貢獻可能落在明年後段，屬券商展望。
- 800VDC 對 Rubin 並非所有部署的必要條件；新建 AI 資料中心與 neocloud 的導入誘因較強，既有機房仍可採替代架構，因此高壓供電採用應按部署條件分階段追蹤。
